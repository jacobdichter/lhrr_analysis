...
url = 'https://web.archive.org/web/20021231222657/http://www.coolrunning.com/bin/res_load/res_print.cgi?r=01/ct/Jun10_Litchf_set1.shtml'
...
print(df.loc[50:150])
df['race_date'] = '2001-06-10'
df['race_year'] = '2001'
print(df.loc[50:150])
df.to_csv('lhrr_2001_results.csv', index=False)