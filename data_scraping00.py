...
url = 'https://web.archive.org/web/20040121152428/http://www.coolrunning.com/bin/res_load/res_print.cgi?r=00/ct/Jun11_Litchf_set1.shtml'
...
print(df.loc[50:150])
df['race_date'] = '2000-06-11'
df['race_year'] = '2000'
print(df.loc[50:150])
df.to_csv('lhrr_2000_results.csv', index=False)